...
def Application(root):
    root.geometry('{}x{}'.format(700, 600))  # 700x600 window
    ...
    name2 = Label(frame1, text = "Here your PDF file", fg= "red", bg="indigo", font="Calibre 25 bold")
    name2.pack()

    #frame2 widgets

    btn = Button(frame2, text = "Select PDF File", activeforeground="red", command = extract_text(), padx="70",
                 pady="10", fg="white", bg="black", font="Arial 12")
    btn.grid(row=0, pady=20, columnspan=2)

    rate_text = Label(frame2, text="Enter Rate of speach", fg="black", bg="aqua", font="Arial 12")
    ...
    submitBtn = Button(frame2, text="Play PDF File", command=speak_text, activeforeground="red", padx="60", pady="10",
                       fg="white", bg="black", font="Arial 12")
    submitBtn.grid(row=4, column=0, pady=65)

    stopBtn = Button(frame2, text="Stop Playing", command=stop_speaking, activeforeground="red", padx="60", pady="10",
                     fg="white", bg="black", font="Arial 12")
